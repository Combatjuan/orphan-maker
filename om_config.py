...
class Config:
    ...
    def load(self, filename):
        ...
        self._estop_sensor_pin = int(pins["estop_sensor"])
    ...
    def validate(self):
        ...
        pins = [
            ...
            self._estop_sensor_pin,
        ]
        # FIXME: Are 9, 10, 11, 0 allowed?
        unconfirmed_gpio_pins = set([1, 8, 9, 10, 11, 14, 15, 16, 19, 25])
        gpio_pins = set([
    ...
    def estop_sensor_pin(self):
        return self._estop_sensor_pin
